...
const reasons = [
  { emoji: "🚫", text: "Stop missing clients who can't reach you" },
  { emoji: "✨", text: "Look more professional than your competitors" },
  { emoji: "📈", text: "Grow your business without working harder" },
];
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground text-sm">Sound familiar? You're in the right place.</p>
          </div>
