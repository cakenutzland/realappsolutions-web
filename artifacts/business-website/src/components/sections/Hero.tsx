        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            <div className="flex flex-col items-center lg:items-start gap-2">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 w-fit">
                ...
                <span className="text-xs font-medium text-white/80 uppercase tracking-wider">Apps · Websites · Tools · SaaS</span>
              </div>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 w-fit">
                ...
                <span className="text-xs font-semibold text-amber-400 uppercase tracking-wider">⚡ 1 client at a time — full dedication to your project</span>
              </div>
            </div>
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0">
              From mobile apps and professional websites to calculators, digital tools, and SaaS products — we build exactly what your business needs to attract more clients and operate smarter.
            </p>

            <ul className="flex flex-col gap-3 text-left mx-auto lg:mx-0">
              {[
                "Mobile apps — so clients can book, order, or reach you 24/7",
                "Professional websites — built to convert visitors into paying clients",
                "Calculators, tools & SaaS — custom digital products for any business need",
              ].map((item, i) => (
          ...
          >
            ...
            >
              ...
              <div>
                <p className="text-xs text-muted-foreground font-medium">New Booking</p>
                <p className="text-sm font-bold text-white">Haircut — 2:00 PM</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <p className="text-xs text-muted-foreground font-medium">Project Delivered</p>
                <p className="text-sm font-bold text-white">CakeNutz Calculator ✓</p>
              </div>
            </motion.div>
